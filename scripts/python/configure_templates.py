...
def render_template(template_path: Path, output_path: Path,
    ...
    # An empty path variable collapses a template path onto the include root, e.g. "" +
    # "/include/x" becomes "/include/x". Caught here instead of failing further downstream.
